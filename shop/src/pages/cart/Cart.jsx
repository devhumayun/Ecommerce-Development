import product1 from '../../assets/images/products/default/1-1.jpg'
import product2 from '../../assets/images/products/default/1-2.jpg'
            ...
            <div className="row gutter-lg mb-10">
                <div className="col-lg-8 pr-lg-4 mb-6">
                    ...
                    <div className="cart-action mb-6">
                        <Link to="/shop" className="btn btn-dark btn-rounded btn-icon-left btn-shopping mr-auto"><i className="w-icon-long-arrow-left"></i>Continue Shopping</Link>
