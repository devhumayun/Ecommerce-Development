...
export const createPermission = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json({ permission, message: "Permission created successfull" });
});
...
export const updatePermission = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json({ permission, message: "Permission updated successfull" });
});
...
//     // update permission
//     const updatedPermissionStatus = await Permissions.findByIdAndUpdate(
//       id,
//       {
//         status: !status,
//       },
...
export const updatePermissionStatus = asyncHandler(async (req, res) => {
    try {
      ...
      return res
        .status(200)
        .json({ permission, message: 'Status updated successful' });
    } catch (error) {
